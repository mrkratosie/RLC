...
public class RLC implements Initializable {
    ...
    void calculate() {
        ...
        this.Z = (double)Math.round(10.0D * Math.sqrt(this.R * this.R + (this.XL - this.XC) * (this.XL - this.XC)))/10.0D;
        this.PhaseInRad = (double)Math.round(10.0D*(Math.atan((this.XL - this.XC) / this.R)))/10.0D;
        this.Phase = (double)Math.round(10.0D*(((Math.atan((this.XL - this.XC) / this.R))/(Math.PI))*180))/10.0D;
